...
export function FinalCTA() {
  return (
    <section className="py-16 sm:py-20 lg:py-24 relative overflow-hidden">
      {/* Background gradient */}
      <div className="absolute inset-0 bg-gradient-to-b from-brand-black via-brand-blue/30 to-brand-black" />
      ...
      <div className="relative z-10 mx-auto max-w-4xl px-5 sm:px-12 lg:px-16 py-10 sm:py-16 text-center glass rounded-3xl overflow-hidden">
        ...
        <TextAnimate
          ...
          animation="blurInUp"
          duration={0.4}
          className="font-display text-xl sm:text-2xl md:text-3xl lg:text-4xl text-white mb-6"
        >
          Sem mensalidade. Sem fidelidade. Sem volume mínimo. Só uma conversa.
        </TextAnimate>

        <BlurFade delay={0.3} inView>
          <p className="text-xs sm:text-sm lg:text-base text-gray-400 max-w-2xl mx-auto mb-8">
