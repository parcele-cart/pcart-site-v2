...
export default function ContatoPage() {
  return (
    <main className="min-h-screen bg-background dark:bg-brand-black">
      ...
      <div className="px-5 sm:px-8 lg:px-16 xl:px-32 2xl:px-[150px] py-16 lg:py-24 space-y-24 lg:space-y-40">
            ...
            <BlurFade key={channel.title} delay={0.2 + i * 0.1} inView>
              <div className="group bg-white dark:bg-zinc-900/50 border border-zinc-200 dark:border-white/8 rounded-3xl p-8 lg:p-10 flex flex-col items-center text-center gap-6 shadow-sm hover:shadow-xl hover:shadow-brand-green/8 dark:hover:shadow-brand-green/5 hover:-translate-y-1 transition-all duration-500 h-full">
                ...
                <div className="relative w-20 h-20 flex items-center justify-center shrink-0">
                  <div className="absolute inset-0 rounded-full bg-brand-green/10 dark:bg-brand-green/10 border border-brand-green/20 group-hover:bg-brand-green group-hover:shadow-[0_0_24px_rgba(94,242,117,0.35)] transition-all duration-500" />
                  <channel.icon className="w-8 h-8 text-brand-green group-hover:text-zinc-900 transition-colors duration-500 z-10" strokeWidth={1.5} />
